...
import { Eye, EyeOff, ArrowLeft, Shield, Zap, Star, Sparkles } from 'lucide-react';
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl text-white/80 leading-relaxed">
                Connect with clubs, discover events, and make your university experience unforgettable.
              </p>
            </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <button className="text-sm text-indigo-600 hover:text-indigo-500 font-semibold transition-colors">
                Forgot password?
              </button>
            </div>
