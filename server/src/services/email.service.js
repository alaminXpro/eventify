...
const sendVerificationEmail = async (to, token) => {
  const subject = 'Email Verification for Eventify';
  // replace this url with the link to the email verification page of your front-end app
  const verificationEmailUrl = `${config.clientURL}/verify-email?token=${token}`;
  const text = `Dear AUST Student,

Welcome to Eventify - the Event Management System for Ahsanullah University of Science and Technology!
...
If you didn't create an account on Eventify, please disregard this email. Your information remains secure, and no action is required on your part.
