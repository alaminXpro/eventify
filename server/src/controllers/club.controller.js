...
const addModeratorToClub = catchAsync(async (req, res) => {
  console.log(req.body);
  const club = await clubService.addModeratorToClub(req.params.clubId, req.body.moderatorId);
  res.send(club);
});
const removeModeratorFromClub = catchAsync(async (req, res) => {
  console.log('removeModeratorFromClub', req.body);
  const club = await clubService.removeModeratorFromClub(req.params.clubId, req.body.moderatorIds);
  res.send(club);
});
